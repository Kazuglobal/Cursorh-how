        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-border bg-muted/50">
              <th className="sticky left-0 bg-muted/50 px-4 py-3 text-left font-semibold min-w-[180px]">
                機能
              </th>
              <th className="px-4 py-3 text-center font-semibold min-w-[150px] text-cyan-600 dark:text-cyan-400">
                Cursor
              </th>
              <th className="px-4 py-3 text-center font-semibold min-w-[150px] text-amber-600 dark:text-amber-400">
                Claude Code
              </th>
              <th className="px-4 py-3 text-center font-semibold min-w-[150px] text-violet-600 dark:text-violet-400">
                Manus AI
              </th>
            </tr>
          </thead>
                ...
                {category.features.map((feature) => (
                  <tr key={feature.id} className="border-b border-border hover:bg-muted/10">
                    ...
                    {(["cursor", "claude-code", "manus"] as const).map((toolId) => {
                      ...
                      return (
                        <td key={toolId} className="px-4 py-3 text-center">
                          <span className={cn(
